 ...
 public function setObjEquipo2($objEquipo2){
    ...
    public function darEquipoGanador(){
        ...
        if ($golesEquipo1>$golesEquipo2){
            $equipoGanador->getObjEquipo1();
            $equipos[]=$equipoGanador;
        } elseif ($golesEquipo2>$golesEquipo1){
            $equipoGanador->getObjEquipo2();
            $equipos[]=$equipoGanador;
        } else {
            $equipos[]=$this->getObjEquipo1();
            $equipos[]=$this->getObjEquipo2();
        }
        return $equipo;
    }

    public function coeficientePartido(){
        $cantidadEquipo1=$this->getObjEquipo1()->getCantJugadores();
        $cantidadEquipo2=$this->getObjEquipo2()->getCantJugadores();
        $cantidadJugadores=$cantidadEquipo1+$cantidadEquipo2;
        $coeficiente=$this->getCoefBase()*($this->getCantGolesE1()+$this->getCantGolesE2())*$cantidadJugadores;
